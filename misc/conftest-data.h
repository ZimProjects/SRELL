...
{
	2, "Compilation error 05: Out of range backref number 1.\n",
	"E",
	RE("a\\1"),
	STR(""),
...
{
	2, "Compilation error 06: Out of range backref number 2.\n",
	"E",
	RE("(?<=\\1a)"),
	STR(""),
	srell::regex_constants::error_backref, 0,
...
{
	0, "Repeat 05a: Nullable groups nested 01.\n",
	"",
	RE("((a|)(|b))*"),
	STR("ab"),
	0, 4,
...
{
	0, "Repeat 05b: Nullable groups nested 02.\n",
	"",
	RE("((a*)(b*?))*"),
	STR("ab"),
	0, 4,
...
{
	0, "Repeat 05c: Nullable groups nested 03.\n",
	"",
	RE("((a?)(b?\x3f))*"),	//  ??) causes a trigraph warning.
	STR("ab"),
	0, 4,
	STR0("ab")
	STR0("b")
...
{
	0, "Repeat 05d: Nullable groups nested 04.\n",
	"",
	RE("((a{0,10})(b{0,10}?))*"),
	STR("ab"),
	0, 4,
...
{
	0, "Repeat 06: Nullable/optional groups nested.\n",
	"",
	RE("((a)*(b)*?)*"),
	STR("ab"),
	0, 4,
...
{
	2, "Three iterators 01: Search succeeds.\n",
	"3",
	RE("(?<=^\\d+).+"),
	STR("0123abcd"),
	4, 1,
...
{
	2, "Three iterators 02: Search fails.\n",
	"3",
	RE("(?<=^\\d+).+"),
	STR("0123abcd"),
	5, 0,
...
{
	2, "Three iteratorts 03: Match fails.\n",
	"3M",
	RE("(?<=^\\d+).+"),
	STR("0123abcd"),
	4, 0,
...
{
	2, "OSEC, GNC 06: Lookaround, greedy.\n",
	"",
	RE("[^;]*(?<=abc);?"),
	STR("abcd"),
	0, 1,
...
{
	2, "OSEC, GNC 07: Lookaround, non-greedy.\n",
	"",
	RE("[^;]*?(?<=abc);?"),
	STR("abcd"),
	0, 1,
...
{
	2, "OSEC, EPS-v2 07: Replacement and restoration of lblim.\n",
	"3",
	RE(".*e(?<=(.*))"),
	STR("0123abcdef"),
	4, 2,
	...
	//  branch_optimisation2().
{
	...
	//  Entry point selector version 3 (Implemented in SRELL 2026.06).
{
	0, "OSEC, EPS-v3 01: SC+non-greedy.\n",
	"",
	RE("\\w{1,3}?@"),
	STR("abcd@"),
	0, 1,
...
{
	2, "Bug4.037-4.038(240127): Lookaround must be 0-width.\n",
	"",
	RE("(?:(?=abc))*"),
	STR("abc"),
	0, 1,
...
{
	2, "Test 5b (ECMAScript 2019 Language Specification 21.2.2.5.1, NOTE 4).\n",
	"",
	RE("(a*)b\\1+"),
	STR("baaaac"),
	0, 2,
...
{
	2, "Test 6a (ECMAScript 2019 Language Specification 21.2.2.8.2, NOTE 2).\n",
	"",
	RE("(?=(a+))"),
	STR("baaabac"),
	0, 2,
...
{
	2, "Test 6b (ECMAScript 2019 Language Specification 21.2.2.8.2, NOTE 2).\n",
	"",
	RE("(?=(a+))a*b\\1"),
	STR("baaabac"),
	0, 2,
...
{
	2, "Test 7 (ECMAScript 2019 Language Specification 21.2.2.8.2, NOTE 3).\n",
	"",
	RE("(.*?)a(?!(a+)b\\2c)\\2(.*)"),
	STR("baaabaac"),
	0, 4,
...
{
	2, "Lookbehind 02a: alternations.js #1.\n",
	"",
	RE(".*(?<=(..|...|....))(.*)"),
	STR("xabcd"),
	0, 3,
...
{
	2, "Lookbehind 02b: alternations.js #2.\n",
	"",
	RE(".*(?<=(xx|...|....))(.*)"),
	STR("xabcd"),
	0, 3,
...
{
	2, "Lookbehind 02c: alternations.js #3.\n",
	"",
	RE(".*(?<=(xx|...))(.*)"),
	STR("xxabcd"),
	0, 3,
...
{
	2, "Lookbehind 02d: alternations.js #4.\n",
	"",
	RE(".*(?<=(xx|xxx))(.*)"),
	STR("xxabcd"),
	0, 3,
...
{
	2, "Lookbehind 03a: back-references-to-captures.js #1.\n",
	"i",
	RE("(?<=\\1(\\w))d"),
	STR("abcCd"),
	0, 2,
...
{
	2, "Lookbehind 03b: back-references-to-captures.js #2.\n",
	"",
	RE("(?<=\\1([abx]))d"),
	STR("abxxd"),
	0, 2,
...
{
	2, "Lookbehind 03c: back-references-to-captures.js #3.\n",
	"",
	RE("(?<=\\1(\\w+))c"),
	STR("ababc"),
	0, 2,
...
{
	2, "Lookbehind 03d: back-references-to-captures.js #4.\n",
	"",
	RE("(?<=\\1(\\w+))c"),
	STR("ababbc"),
	0, 2,
...
{
	2, "Lookbehind 03e: back-references-to-captures.js #5.\n",
	"",
	RE("(?<=\\1(\\w+))c"),
	STR("ababdc"),
	0, 0,
...
{
	2, "Lookbehind 03f: back-references-to-captures.js #6.\n",
	"",
	RE("(?<=(\\w+)\\1)c"),
	STR("ababc"),
	0, 2,
...
{
	2, "Lookbehind 04a: back-references.js #1.\n",
	"",
	RE("(.)(?<=(\\1\\1))"),
	STR("abb"),
	0, 3,
...
{
	2, "Lookbehind 04b: back-references.js #2.\n",
	"i",
	RE("(.)(?<=(\\1\\1))"),
	STR("abB"),
	0, 3,
...
{
	2, "Lookbehind 04c: back-references.js #3.\n",
	"i",
	RE("((\\w)\\w)(?<=\\1\\2\\1)"),
	STR("aabAaBa"),
	0, 3,
...
{
	2, "Lookbehind 04d: back-references.js #4.\n",
	"i",
	RE("(\\w(\\w))(?<=\\1\\2\\1)"),
	STR("aabAaBa"),
	0, 3,
...
{
	2, "Lookbehind 04e: back-references.js #5.\n",
	"i",
	RE("(?=(\\w))(?<=(\\1))."),
	STR("abaBbAa"),
	0, 3,
...
{
	2, "Lookbehind 04f: back-references.js #6.\n",
	"",
	RE("(?<=(.))(\\w+)(?=\\1)"),
	STR("  'foo'  "),
	0, 3,
...
{
	2, "Lookbehind 04g: back-references.js #7.\n",
	"",
	RE("(?<=(.))(\\w+)(?=\\1)"),
	STR("  \"foo\"  "),
	0, 3,
...
{
	2, "Lookbehind 04h: back-references.js #8.\n",
	"",
	RE("(.)(?<=\\1\\1\\1)"),
	STR("abbb"),
	0, 2,
...
{
	2, "Lookbehind 04i: back-references.js #9.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("fababab"),
	0, 2,
...
{
	2, "Lookbehind 04j: back-references.js #10.\n",
	"",
	RE("(?<=(.))(\\w+)(?=\\1)"),
	STR("  .foo\"  "),
	0, 0,
...
{
	2, "Lookbehind 04k: back-references.js #11.\n",
	"",
	RE("(.)(?<=\\1\\1\\1)"),
	STR("ab"),
	0, 0,
...
{
	2, "Lookbehind 04l: back-references.js #12.\n",
	"",
	RE("(.)(?<=\\1\\1\\1)"),
	STR("abb"),
	0, 0,
...
{
	2, "Lookbehind 04l: back-references.js #13.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("ab"),
	0, 0,
...
{
	2, "Lookbehind 04m: back-references.js #14.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("abb"),
	0, 0,
...
{
	2, "Lookbehind 04n: back-references.js #15.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("aabb"),
	0, 0,
...
{
	2, "Lookbehind 04o: back-references.js #16.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("abab"),
	0, 0,
...
{
	2, "Lookbehind 04p: back-references.js #17.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("fabxbab"),
	0, 0,
...
{
	2, "Lookbehind 04q: back-references.js #18.\n",
	"",
	RE("(..)(?<=\\1\\1\\1)"),
	STR("faxabab"),
	0, 0,
...
{
	2, "Lookbehind 05: captures-negative.js.\n",
	"",
	RE("(?<!(^|[ab]))\\w{2}"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 06a: captures.js #1.\n",
	"",
	RE("(?<=(c))def"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 06b: captures.js #2.\n",
	"",
	RE("(?<=(\\w{2}))def"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 06c: captures.js #3.\n",
	"",
	RE("(?<=(\\w(\\w)))def"),
	STR("abcdef"),
	0, 3,
...
{
	2, "Lookbehind 06d: captures.js #4.\n",
	"",
	RE("(?<=(\\w){3})def"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 06e: captures.js #5.\n",
	"",
	RE("(?<=(bc)|(cd))."),
	STR("abcdef"),
	0, 3,
...
{
	2, "Lookbehind 06f: captures.js #6.\n",
	"",
	RE("(?<=([ab]{1,2})\\D|(abc))\\w"),
	STR("abcdef"),
	0, 3,
...
{
	2, "Lookbehind 06g: captures.js #7.\n",
	"",
	RE("\\D(?<=([ab]+))(\\w)"),
	STR("abcdef"),
	0, 3,
...
{
	2, "Lookbehind 06h: captures.js #8.\n",
	"G",
	RE("(?<=b|c)\\w"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 06i: captures.js #9.\n",
	"G",
	RE("(?<=[b-e])\\w{2}"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 07: do-not-backtrack.js.\n",
	"",
	RE("(?<=([abc]+)).\\1"),
	STR("abcdbc"),
	0, 0,
...
{
	2, "Lookbehind 08a: greedy-loop.js #1.\n",
	"",
	RE("(?<=(b+))c"),
	STR("abbbbbbc"),
	0, 2,
...
{
	2, "Lookbehind 08b: greedy-loop.js #2.\n",
	"",
	RE("(?<=(b\\d+))c"),
	STR("ab1234c"),
	0, 2,
...
{
	2, "Lookbehind 08c: greedy-loop.js #3.\n",
	"",
	RE("(?<=((?:b\\d{2})+))c"),
	STR("ab12b23b34c"),
	0, 2,
...
{
	2, "Lookbehind 10a: mutual-recursive.js #1.\n",
	"",
	RE("(?<=a(.\\2)b(\\1)).{4}"),
	STR("aabcacbc"),
	0, 3,
...
{
	2, "Lookbehind 10b: mutual-recursive.js #2.\n",
	"",
	RE("(?<=a(\\2)b(..\\1))b"),
	STR("aacbacb"),
	0, 3,
...
{
	2, "Lookbehind 10c: mutual-recursive.js #3.\n",
	"",
	RE("(?<=(?:\\1b)(aa))."),
	STR("aabaax"),
	0, 2,
...
{
	2, "Lookbehind 10d: mutual-recursive.js #4.\n",
	"",
	RE("(?<=(?:\\1|b)(aa))."),
	STR("aaaax"),
	0, 2,
...
{
	2, "Lookbehind 11a: negative.js #1.\n",
	"",
	RE("(?<!abc)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 11b: negative.js #2.\n",
	"",
	RE("(?<!a.c)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 11c: negative.js #3.\n",
	"",
	RE("(?<!a\\wc)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 11d: negative.js #4.\n",
	"",
	RE("(?<!a[a-z])\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 11e: negative.js #5.\n",
	"",
	RE("(?<!a[a-z]{2})\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 11f: negative.js #6.\n",
	"",
	RE("(?<!abc)def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11g: negative.js #7.\n",
	"",
	RE("(?<!a.c)def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11h: negative.js #8.\n",
	"",
	RE("(?<!a\\wc)def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11i: negative.js #9.\n",
	"",
	RE("(?<!a[a-z][a-z])def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11j: negative.js #10.\n",
	"",
	RE("(?<!a[a-z]{2})def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11k: negative.js #11.\n",
	"",
	RE("(?<!a{1}b{1})cde"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 11l: negative.js #12.\n",
	"",
	RE("(?<!a{1}[a-z]{2})def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 12a: nested-lookaround.js #1.\n",
	"",
	RE("(?<=ab(?=c)\\wd)\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 12b: nested-lookaround.js #2.\n",
	"",
	RE("(?<=a(?=([^a]{2})d)\\w{3})\\w\\w"),
	STR("abcdef"),
	0, 2,
...
{
	2, "Lookbehind 12c: nested-lookaround.js #3.\n",
	"",
...
{
	2, "Lookbehind 12d: nested-lookaround.js #4.\n",
	"",
	RE("^faaao?(?<=^f[oa]+(?=o))"),
	STR("faaao"),
	0, 1,
...
{
	2, "Lookbehind 12e: nested-lookaround.js #5.\n",
	"",
...
{
	2, "Lookbehind 13a: simple-fixed-length.js #1.\n",
	"",
	RE("^.(?<=a)"),
	STR("b"),
	0, 0,
...
{
	2, "Lookbehind 13b: simple-fixed-length.js #2.\n",
	"",
	RE("^f\\w\\w(?<=\\woo)"),
	STR("boo"),
	0, 0,
...
{
	2, "Lookbehind 13c: simple-fixed-length.js #3.\n",
	"",
	RE("^f\\w\\w(?<=\\woo)"),
	STR("fao"),
	0, 0,
...
{
	2, "Lookbehind 13d: simple-fixed-length.js #4.\n",
	"",
	RE("^f\\w\\w(?<=\\woo)"),
	STR("foa"),
	0, 0,
...
{
	2, "Lookbehind 13e: simple-fixed-length.js #5.\n",
	"",
	RE("^.(?<=a)"),
	STR("a"),
	0, 1,
...
{
	2, "Lookbehind 13f: simple-fixed-length.js #6.\n",
	"",
	RE("^f..(?<=.oo)"),
	STR("foo1"),
	0, 1,
...
{
	2, "Lookbehind 13g: simple-fixed-length.js #7.\n",
	"",
	RE("^f\\w\\w(?<=\\woo)"),
	STR("foo2"),
	0, 1,
...
{
	2, "Lookbehind 13h: simple-fixed-length.js #8.\n",
	"",
	RE("(?<=abc)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13i: simple-fixed-length.js #9.\n",
	"",
	RE("(?<=a.c)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13j: simple-fixed-length.js #10.\n",
	"",
	RE("(?<=a\\wc)\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13k: simple-fixed-length.js #11.\n",
	"",
	RE("(?<=a[a-z])\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13l: simple-fixed-length.js #12.\n",
	"",
	RE("(?<=a[a-z][a-z])\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13m: simple-fixed-length.js #13.\n",
	"",
	RE("(?<=a[a-z]{2})\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13n: simple-fixed-length.js #14.\n",
	"",
	RE("(?<=a{1})\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13o: simple-fixed-length.js #15.\n",
	"",
	RE("(?<=a{1}b{1})\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 13p: simple-fixed-length.js #16.\n",
	"",
	RE("(?<=a{1}[a-z]{2})\\w\\w\\w"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 14a: sliced-strings.js #1.\n",
	"i",
...
{
	2, "Lookbehind 14b: sliced-strings.js #2.\n",
	"",
	RE("(?=(abcdefghijklmn))(?<=\\1)a"),
	STR("abcdefghijklmnabcdefghijklmn"),
	14, 0,
...
{
	2, "Lookbehind 14c: sliced-strings.js #3.\n",
	"",
	RE("(?=(abcdefg))(?<=\\1)"),
	STR("abcdefgabcdefg"),
	1, 0,
...
{
	2, "Lookbehind 15a: start-of-line.js #1.\n",
	"",
	RE("(?<=^[^a-c]{3})def"),
	STR("abcdef"),
	0, 0,
...
{
	2, "Lookbehind 15b: start-of-line.js #2.\n",
	"",
	RE("\"^foooo(?<=^o+)$"),
	STR("foooo"),
	0, 0,
...
{
	2, "Lookbehind 15c: start-of-line.js #3.\n",
	"",
	RE("\"^foooo(?<=^o*)$"),
	STR("foooo"),
	0, 0,
...
{
	2, "Lookbehind 15d: start-of-line.js #4.\n",
	"",
	RE("(?<=^abc)def"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 15e: start-of-line.js #5.\n",
	"",
	RE("(?<=^[a-c]{3})def"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 15f: start-of-line.js #6.\n",
	"m",
	RE("(?<=^[a-c]{3})def"),
	STR("xyz\nabcdef"),
	0, 1,
...
{
	2, "Lookbehind 15g: start-of-line.js #7.\n",
	"mG",
	RE("(?<=^)\\w+"),
	STR("ab\ncd\nefg"),
	0, 3,
...
{
	2, "Lookbehind 15h: start-of-line.js #8.\n",
	"mG",
	RE("\\w+(?<=$)"),
	STR("ab\ncd\nefg"),
	0, 3,
...
{
	2, "Lookbehind 15i: start-of-line.js #9.\n",
	"mG",
	RE("(?<=^)\\w+(?<=$)"),
	STR("ab\ncd\nefg"),
	0, 3,
...
{
	2, "Lookbehind 15j: start-of-line.js #10.\n",
	"",
	RE("^foo(?<=^fo+)$"),
	STR("foo"),
	0, 1,
...
{
	2, "Lookbehind 15k: start-of-line.js #11.\n",
	"",
	RE("^foooo(?<=^fo*)"),
	STR("foooo"),
	0, 1,
...
{
	2, "Lookbehind 15l: start-of-line.js #12.\n",
	"",
	RE("^(f)oo(?<=^\\1o+)$"),
	STR("foo"),
	0, 2,
...
{
	2, "Lookbehind 15m: start-of-line.js #13.\n",
	"i",
	RE("^(f)oo(?<=^\\1o+)$"),
	STR("foo"),
	0, 2,
...
{
	2, "Lookbehind 15n: start-of-line.js #14.\n",
	"i",
	RE("^(f)oo(?<=^\\1o+).$"),
	STR("foo\\u1234"),
	0, 2,
...
{
	2, "Lookbehind 15o: start-of-line.js #15.\n",
	"",
	RE("(?<=^\\w+)def"),
	STR("abcdefdef"),
	0, 1,
...
{
	2, "Lookbehind 15p: start-of-line.js #16.\n",
	"G",
	RE("(?<=^\\w+)def"),
	STR("abcdefdef"),
	0, 2,
...
{
	2, "Lookbehind 16ab: sticky.js #1-2.\n",
	"A",
	RE("(?<=^(\\w+))def"),
	STR("abcdefdef"),
	0, 4,
...
{
	2, "Lookbehind 17a: variable-length.js #1.\n",
	"",
	RE("(?<=[a|b|c]*)[^a|b|c]{3}"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 17b: variable-length.js #2.\n",
	"",
	RE("(?<=\\w*)[^a|b|c]{3}"),
	STR("abcdef"),
	0, 1,
...
{
	2, "Lookbehind 18a: word-boundary.js #1.\n",
	"",
	RE("(?<=\\b)[d-f]{3}"),
	STR("abc def"),
	0, 1,
...
{
	2, "Lookbehind 18b: word-boundary.js #2.\n",
	"",
	RE("(?<=\\B)\\w{3}"),
	STR("ab cdef"),
	0, 1,
...
{
	2, "Lookbehind 18c: word-boundary.js #3.\n",
	"",
	RE("(?<=\\B)(?<=c(?<=\\w))\\w{3}"),
	STR("ab cdef"),
	0, 1,
...
{
	2, "Lookbehind 18d: word-boundary.js #4.\n",
	"",
	RE("(?<=\\b)[d-f]{3}"),
	STR("abcdef"),
	0, 0,
...
{
	2, "named-groups 01a: lookbehind.js #1.\n",
	"",
	RE("(?<=(?<a>\\w){3})f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01c: lookbehind.js #2.\n",
	"",
	RE("(?<=(?<a>\\w){4})f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01d: lookbehind.js #3.\n",
	"",
	RE("(?<=(?<a>\\w)+)f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01e: lookbehind.js #4.\n",
	"",
	RE("(?<=(?<a>\\w){6})f"),
	STR("abcdef"),
	0, 0,
...
{
	2, "named-groups 01f: lookbehind.js #5.\n",
	"",
	RE("((?<=\\w{3}))f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01g: lookbehind.js #6.\n",
	"",
	RE("(?<a>(?<=\\w{3}))f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01h: lookbehind.js #7.\n",
	"",
	RE("(?<!(?<a>\\d){3})f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01i: lookbehind.js #8.\n",
	"",
	RE("(?<!(?<a>\\D){3})f"),
	STR("abcdef"),
	0, 0,
...
{
	2, "named-groups 01j: lookbehind.js #9.\n",
	"",
	RE("(?<!(?<a>\\D){3})f|f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 01k: lookbehind.js #10.\n",
	"",
	RE("(?<a>(?<!\\D{3}))f|f"),
	STR("abcdef"),
	0, 2,
...
{
	2, "named-groups 02a: unicode-match.js #1.\n",
	"",
...
{
	2, "named-groups 02b: unicode-match.js #2.\n",
	"",
	RE("(?<b>b).\\1"),
	STR("bab"),
	0, 2,
...
{
	2, "named-groups 02c: unicode-match.js #3.\n",
	"",
	RE("(.)(?<a>a)\\1\\2"),
	STR("baba"),
	0, 3,
...
{
	2, "named-groups 02d: unicode-match.js #4.\n",
	"",
	RE("(.)(?<a>a)(?<b>\\1)(\\2)"),
	STR("baba"),
	0, 5,
...
{
	2, "named-groups 03a: unicode-references.js #1.\n",
	"",
	RE("(?<b>.).\\k<b>"),
	STR("bab"),
	0, 2,
...
{
	2, "named-groups 03b: unicode-references.js #2.\n",
	"",
	RE("(?<b>.).\\k<b>"),
	STR("baa"),
	0, 0,
...
{
	2, "named-groups 03c: unicode-references.js #3.\n",
	"",
	RE("(?<a>\\k<a>\\w).."),
	STR("bab"),
	0, 2,
...
{
	2, "named-groups 03d: unicode-references.js #4.\n",
	"",
	RE("\\k<a>(?<a>b)\\w\\k<a>"),
	STR("bab"),
	0, 2,
...
{
	2, "named-groups 03e: unicode-references.js #5.\n",
	"",
	RE("(?<b>b)\\k<a>(?<a>a)\\k<b>"),
	STR("bab"),
	0, 3,
...
{
	2, "named-groups 03f: unicode-references.js #6.\n",
	"",
	RE("(?<a>a)(?<b>b)\\k<a>"),
	STR("aba"),
	0, 3,
...
{
	2, "named-groups 03g: unicode-references.js #7.\n",
	"",
	RE("(?<a>a)(?<b>b)\\k<a>|(?<c>c)"),
	STR("aba"),
	0, 4,
...
{
	2, "named-groups 04c: duplicate-names-(exec|match|test).js #3.\n",
	"",
	RE("(?:(?<x>a)|(?<x>b))\\k<x>"),
	STR("aa"),
	0, 3,
...
{
	2, "named-groups 04d: duplicate-names-(exec|match|test).js #4.\n",
	"",
	RE("(?:(?<x>a)|(?<x>b))\\k<x>"),
	STR("bb"),
	0, 3,
...
{
	2, "named-groups 04e: duplicate-names-(exec|match|test).js #5.\n",
	"N",
	RE("(?:(?:(?<x>a)|(?<x>b))\\k<x>){2}"),
	STR("aabb"),
	0, 3,
...
{
	2, "named-groups 04f: duplicate-names-(exec|match|test).js #6.\n",
	"",
	RE("(?:(?:(?<x>a)|(?<x>b))\\k<x>){2}"),
	STR("abab"),
	0, 0,
...
{
	2, "named-groups 04g: duplicate-names-(exec|match).js #7.\n",
	"",
	RE("(?:(?<x>a)|(?<x>b))\\k<x>"),
	STR("abab"),
	0, 0,
...
{
	2, "named-groups 04h: duplicate-names-(exec|match).js #8.\n",
	"",
	RE("(?:(?<x>a)|(?<x>b))\\k<x>"),
	STR("cdef"),
	0, 0,
...
{
	2, "named-groups 04i: duplicate-names-(exec|match).js #9.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z)\\k<a>$"),
	STR("xx"),
	0, 3,
...
{
	2, "named-groups 04j: duplicate-names-(exec|match).js #10.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z)\\k<a>$"),
	STR("z"),
	0, 3,
...
{
	2, "named-groups 04k: duplicate-names-(exec|match).js #11.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z)\\k<a>$"),
	STR("zz"),
	0, 0,
...
{
	2, "named-groups 04l: duplicate-names-(exec|match).js #12.\n",
	"",
	RE("(?<a>x)|(?:zy\\k<a>)"),
	STR("zy"),
	0, 2,
...
{
	2, "named-groups 04m: duplicate-names-(exec|match).js #13.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z){2}\\k<a>$"),
	STR("xz"),
	0, 3,
...
{
	2, "named-groups 04n: duplicate-names-(exec|match).js #14.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z){2}\\k<a>$"),
	STR("yz"),
	0, 3,
...
{
	2, "named-groups 04o: duplicate-names-(exec|match).js #15.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z){2}\\k<a>$"),
	STR("xzx"),
	0, 0,
...
{
	2, "named-groups 04p: duplicate-names-(exec|match).js #16.\n",
	"",
	RE("^(?:(?<a>x)|(?<a>y)|z){2}\\k<a>$"),
	STR("yzy"),
	0, 0,
